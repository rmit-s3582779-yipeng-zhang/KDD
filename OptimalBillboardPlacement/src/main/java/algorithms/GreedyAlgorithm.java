...
public class GreedyAlgorithm {
    ...
    public void greedy(List<Billboard> remainingBillboards, double budget, ClusterBillboard cluster,int index) {
        ...
        pickOne(board, remainingBillboards, cluster, budgetRemains);
        ...
        while (budgetRemains > 0) {
            ...
            if (remainingBillboards.get(0).charge > budgetRemains) {
            ...
            pickOne(firstBoard, remainingBillboards, cluster, budgetRemains);
    ...
    private void pickOne(Billboard billboard, List<Billboard> remainingBoards, ClusterBillboard cluster, double budgetRemain) {
